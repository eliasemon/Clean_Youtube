...
const CardLoader = () =>{
    ...
    const NtUi = (<div style = {{width : '100%', height : '89vh' , display : 'flex' , justifyContent : 'center' ,alignItems : 'center'}}><img style={{margin : '0 auto' ,width : `${(windowWidth / 1.5)}px`  }} src={logo} alt="Nothing Found" /></div>)
